    ...
    <div className={`bg-white dark:bg-gray-800 rounded-lg p-4 shadow ${className}`}>
      <div className="mb-4">
        <div className="flex justify-between items-center">
          <span className="text-lg font-semibold text-gray-600 dark:text-gray-400">Score</span>
          <div 
      ...
      {state.gameStatus === 'finished' && (
        <div className="mt-4 p-2 bg-indigo-100 dark:bg-indigo-900 rounded text-center">
          <p className="text-indigo-800 dark:text-indigo-200 font-medium">Game Over!</p>
      ...
      {state.gameStatus === 'paused' && (
        <div className="mt-4 p-2 bg-yellow-100 dark:bg-yellow-900 rounded text-center">
          <p className="text-yellow-800 dark:text-yellow-200 font-medium">Game Paused</p>
        </div>
      )}
    </div>
  );
